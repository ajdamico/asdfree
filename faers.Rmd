...
* Voluntary reports from practitioners, consumers, mandatory reports from manufacturers.

* Published quarterly since 2004, revisions at 2012Q4 and 2014Q3.
...
1. `ASC_NTS.DOC` included in each quarterly zipped file, especially the Entity Relationship Diagram
...
Import multiple files from the current quarter:
```{r eval = FALSE , results = "hide" }
