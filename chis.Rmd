...
Harmonize the general health condition across the three `data.frame` objects:
```{r cache = TRUE , warning = FALSE , message = FALSE , results = "hide" }
