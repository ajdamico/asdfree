...
## Identify the Joinpoint, Breakpoint, or Changepoint {-}
...
ggplot( means_for_joinpoint , aes( x = year , y = mean ) ) +
...
```{r eval = FALSE }
# add a segmented variable (`year` in this example) with 1 breakpoint
os <- segmented( o , ~year )
