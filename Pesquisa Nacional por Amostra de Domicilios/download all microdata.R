...
###################################################################################
# Analyze the 2001 - 2014 Pesquisa Nacional por Amostra de Domicilios file with R #
###################################################################################


# set your working directory.
# the PNAD 2001 - 2014 data files will be stored here
...
# install.packages( c("MonetDB.R", "MonetDBLite" , "survey" , "SAScii" , "descr" , "downloader" , "digest" , "stringr" , "R.utils" ) , repos=c("https://dev.monetdb.org/Assets/R/", "http://cran.rstudio.com/"))
...
for ( year in years.to.download ){
	...
	# if the files aren't already in a convenient zipped file..
		...
		for ( this.file in c( "Dados.zip" , "Dicionarios_e_input.zip" ) ) {
			...
			if( year == 2014 ) this.file <- gsub( "\\.zip" , "_20160406.zip" , this.file )
