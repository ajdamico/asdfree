...
* Two tables, the first with one per library system, the second with one row per library building or bookmobile.
...
2. `README FY #### PLS PUD.txt` included in each [zipped file](https://www.imls.gov/sites/default/files/2023-06/pls_fy2021_csv.zip)
