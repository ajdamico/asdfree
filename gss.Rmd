...
Match the unweighted record count on [PDF page 11](https://gss.norc.org/Documents/codebook/GSS%202022%20Codebook.pdf#page=11) of the Public Use File codebook:
```{r eval = FALSE , results = "hide" }
