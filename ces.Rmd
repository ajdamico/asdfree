...
## Replication Example {-}
This example matches the _number of consumer units_ and the _Cars and trucks, new_ rows of [Table R-1](https://www.bls.gov/cex/tables/calendar-year/mean/cu-all-detail-2022.pdf):
```{r eval = FALSE , results = "hide" }
result <-
