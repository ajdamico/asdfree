...
# 1992 - 2010 public use file (version M)
...
dbSendQuery( db , "CREATE TABLE temp10resp AS SELECT * FROM hrsM WHERE r10wtresp >= 0" )
dbSendQuery( db , "CREATE TABLE temp4resp AS SELECT * FROM hrsM WHERE r4wtresp >= 0" )
