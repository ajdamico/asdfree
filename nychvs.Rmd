...
Merge the information stored in the all units table onto both the occupied and vacant unit tables, then the information (not related to weighting) from the occupied unit table onto the person table:
...
Construct four designs representing four different levels of analysis:
