...
# source_url( "https://raw.github.com/ajdamico/asdfree/master/General%20Social%20Survey/cumulative%20cross-sectional%20-%20analysis%20examples.R" , prompt = FALSE , echo = TRUE )
# # # # # # # # # # # # # # #
