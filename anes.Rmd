...
1. [Between 2012 and 2020, younger Americans are less politically polarized on climate policies](https://doi.org/10.1371/journal.pone.0302434).

2. [Between 1996 and 2016, groups least likely to use the Internet experienced larger changes in political polarization than those more likely to use the Internet](https://doi.org/10.1073/pnas.1706588114).

3. [In 2020, 90% of Biden and Trump voters also opted for a congressional candidate of the same party](https://rollcall.com/2024/05/14/will-the-last-ticket-splitting-voter-please-turn-out-the-light/).
