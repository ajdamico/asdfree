...
sipp.core.waves <- 1:15																	# either choose which core survey waves to download, or set to NULL
sipp.replicate.waves <- 1:15															# either choose which replicate weight waves to download, or set to NULL
