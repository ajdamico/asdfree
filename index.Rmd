...
Please ask questions about this book on [cross validated](https://stats.stackexchange.com/questions/ask?tags=survey) for survey statistics or [stackoverflow](https://stackoverflow.com/questions/ask?tags=r+survey) for `R`. Contribute to this resource via [GitHub](https://github.com/ajdamico/asdfree/).
