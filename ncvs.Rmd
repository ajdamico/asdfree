...
* Released annually since its 1992 rename and re-design, related surveys dating to early 1970s.
...
Limit columns in each data.frame to those specified above, also to the period 1994-2022 excluding 2006:
```{r cache = TRUE , warning = FALSE , message = FALSE , results = "hide" }
ncvs_household_df <-
	ncvs_household_df[ 
