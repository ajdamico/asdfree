...
```{r eval = FALSE , results = "hide" }
nationwide_adult_population <- svytotal( ~ pia , pnadc_design , na.rm = TRUE )
...
nationwide_not_in_labor_force <-
	svytotal( ~ as.numeric( pia & !pea_c ) , pnadc_design , na.rm = TRUE )
