...
# source_url( "https://raw.githubusercontent.com/ajdamico/asdfree/master/American%20Time%20Use%20Survey/2012%20single-year%20-%20analysis%20examples.R" , prompt = FALSE , echo = TRUE )
# # # # # # # # # # # # # # #
