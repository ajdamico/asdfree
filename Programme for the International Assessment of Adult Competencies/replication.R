...
# source_url( "https://raw.github.com/ajdamico/usgsd/master/Programme%20for%20the%20International%20Assessment%20of%20Adult%20Competencies/replication.R" , prompt = FALSE , echo = TRUE )
# # # # # # # # # # # # # # #
