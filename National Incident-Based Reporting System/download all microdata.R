...
# install.packages( c( "MonetDB.R" , "MonetDBLite" , "RCurl" , "SAScii" , "descr" , "downloader" , "digest" , "stringr" , "R.utils" ) , repos=c("http://dev.monetdb.org/Assets/R/", "http://cran.rstudio.com/"))
