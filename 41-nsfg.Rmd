...
The example below matches statistics and confidence intervals from this table pulled from the [CDC](https://www.cdc.gov/nchs/data/nsfg/NSFG_2013_2015_VarEst_Ex1.pdf) variance estimation examples:
